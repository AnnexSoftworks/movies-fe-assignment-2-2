...
movie.pk" data-bs-parent="#collapsable-card">
          <div class="card-body">
            ...
            <div v-if="this.authenticated === 'true'" class="btn-group">
              <button @click="updateMovie(movie)" style="background-color: transparent; padding: 5px;">
                <font-awesome-icon icon="pencil"/>
              </button>
              <button @click="deleteMovie(movie)" style="background-color: transparent; padding: 5px;">
